...
var main_a = function () { return __awaiter(void 0, void 0, void 0, function () {
    var file, characters, lastFourCharacters, total, _i, characters_1, character, uniqueCharacters;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, read_file_1.asyncReadFile)('src/day_6/input.txt')];
            case 1:
                file = _a.sent();
                characters = file[0].split('');
                lastFourCharacters = [];
                total = 0;
                for (_i = 0, characters_1 = characters; _i < characters_1.length; _i++) {
                    character = characters_1[_i];
                    if (lastFourCharacters.length === 4) {
                        uniqueCharacters = new Set(lastFourCharacters);
...
var main_b = function () { return __awaiter(void 0, void 0, void 0, function () {
    var file, characters, lastFourCharacters, total, _i, characters_2, character, uniqueCharacters;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, read_file_1.asyncReadFile)('src/day_6/input.txt')];
            case 1:
                ...
                lastFourCharacters = [];
                total = 0;
                for (_i = 0, characters_2 = characters; _i < characters_2.length; _i++) {
                    character = characters_2[_i];
